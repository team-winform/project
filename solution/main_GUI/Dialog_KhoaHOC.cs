    ...
    public partial class Dialog_KhoaHOC : Form
    {
        ...
        private void Dialog_KhoaHOC_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                Dictionary<String, String> kh = this.khoaHocBLL.findKhoaHoc(ma);
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    int result;
                    if (type == 1) result = this.khoaHocBLL.addKhoaHoc(txtTen.Text.Trim(), txtGia.Text.Trim(), txtGhiChu.Text.Trim());
